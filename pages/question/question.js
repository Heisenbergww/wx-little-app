...
Page({
  ...
  onLoad: function (options) {
    ...
    wx.request({
      url: 'https://www.wangyuhui.site/qa/randomGetDemoQuestion',
      method: 'get',
  ...
  getAllPageData:function(quest){
    ...
    wx.request({
      url: 'https://www.wangyuhui.site/qa/getAnswerOfQuestion?question=' + quest,
      method: 'get',
      header: { 'content-type': 'application/json' },
      data: {
      },
  ...
  endRecode: function () {//结束录音 
    ...
    recorderManager.onStop((res) => {
      ...
      var urls = "https://www.wangyuhui.site/judge/GetResult/weChat/uploadVoice";
      wx.uploadFile({
        url: urls,
        ...
        success: function (ress) {
          ...
          wx.request({
            url: 'https://www.wangyuhui.site/judge/GetResult/Sentence',
            data: {
            },
            method: 'POST',
            header: {
