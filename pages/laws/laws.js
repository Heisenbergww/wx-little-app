 ...
 */
  ...
  getOneLaw:function(){
    ...
    switch(this.data.lawIndex){
      case ("0"): law_url ="https://www.wangyuhui.site/criminalsearch/getLawTable";break;
      case ("1"): law_url = "https://www.wangyuhui.site/trafficsearch/getLawTable"; break;
      case ("2"): law_url = "https://www.wangyuhui.site/laborsearch/getLaborLawTable"; break;
      case ("3"): law_url = "https://www.wangyuhui.site/trafficscoresearch/getTrafficScoreLawTable"; break;
      case ("4"): law_url = "https://www.wangyuhui.site/marriagesearch/getMarriageLawTable"; break;
      case ("5"): law_url = "https://www.wangyuhui.site/civilsearch/getLawTable"; break;
      case ("6"): law_url = "https://www.wangyuhui.site/securitysearch/getLawTable"; break;
      case ("7"): law_url = "https://www.wangyuhui.site/fundsearch/getLaborLawTable"; break;
      case ("8"): law_url = "https://www.wangyuhui.site/contractsearch/getLawTable"; break;
      case ("9"): law_url = "https://www.wangyuhui.site/consumersearch/getConsumerLawTable"; break;
      case ("10"): law_url = "https://www.wangyuhui.site/insurancesearch/getLawTable"; break;
      case ("11"): law_url = "https://www.wangyuhui.site/protectsearch/getLawTable"; break;  
        
      default: law_url = "https://www.wangyuhui.site/criminalsearch/getLawTable";
    }
    wx.request({
      url: law_url,
      method: 'get',
  ...
  getCriminalList:function(){
    var _this = this;
    wx.request({
      url: "https://www.wangyuhui.site/kg/getTable",
      method: 'get',
      header: { 'content-type': 'application/json' },
      data: {
      },
