...
Page({
  ...
  onLoad: function (options) {
    var _this = this;
    wx.request({
      url: 'https://www.wangyuhui.site/lawpredict/randomGetDemoCase',
      method: 'get',
  ...
  getAllPageData: function (quest) {
    ...
    wx.request({
      url: 'https://www.wangyuhui.site/lawpredict/getResult?criminal_case=' + quest,
      method: 'get',
      header: { 'content-type': 'application/json' },
      data: {
      },
  ...
  chooseImg: function () {
    ...
    wx.chooseImage({
      ...
      success: function (res) {
        ...
        wx.uploadFile({
          url: 'https://www.wangyuhui.site/judge/GetResult/weChat/uploadImage', //仅为示例，非真实的接口地址
          ...
          success: function (res) {
            ...
            //do something
            wx.request({
              url: 'https://www.wangyuhui.site/judge/GetResult/GeneralOCR',
              data: {
      ...
      success: function (res) {
        ...
        wx.uploadFile({
          ...
          success: function (res) {
            ...
            wx.request({
              url: 'https://www.wangyuhui.site/judge/GetResult/HandWriteOCR',
              data: {
