...
Page({
  ...
  askData: function () {
    ...
    if (type == "partNum") {
      ...
      url = 'https://www.wangyuhui.site/marriagesearch/getMarriageLawByChapterNum?chapterNum=' + info.chapterNum + '&pageSize=10&pageNum=' + this.data.needpage
      ...
      url = encodeURI('https://www.wangyuhui.site/marriagesearch/getMarriageLawByQueryString?queryString=' + info.keywords + '&pageSize=10&pageNum=' + this.data.needpage)
    }
    console.log(url)
